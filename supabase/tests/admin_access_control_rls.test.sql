...
values
    ('20000000-0000-0000-0000-000000000001', 'member@nexerp.internal', '{"provisioning_nonce":"nonce-member-000001"}'::jsonb, '{"login_id":"member","nexerp_provisioned":true}'::jsonb),
    ('20000000-0000-0000-0000-000000000002', 'adminuser@nexerp.internal', '{"provisioning_nonce":"nonce-adminuser-0002"}'::jsonb, '{"login_id":"adminuser","nexerp_provisioned":true}'::jsonb),
    ('20000000-0000-0000-0000-000000000003', 'inactive@nexerp.internal', '{"provisioning_nonce":"nonce-inactive-00003"}'::jsonb, '{"login_id":"inactive","nexerp_provisioned":true}'::jsonb);
