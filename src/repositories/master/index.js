...
export const MASTER_REPOSITORY_METHODS = Object.freeze(['listCompanies', 'createCompany', 'updateCompany', 'listSites', 'createSite', 'updateSite', 'listPartners', 'createPartner', 'updatePartner', 'listItems', 'createItem', 'updateItem']);
