...
const history = () => ({
    ...
    employments: [
        { id: cycle1, sequenceNo: 1, hireDate: '2020-01-01', endDate: '2026-09-15', status: 'terminated', siteId: null, department: 'D1', grade: 'STAFF', position: 'MEMBER', cancelled: false, cancellationReason: null, accountChanged: false, actions: [] },
